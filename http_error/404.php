    ...
    <body>
        ...
        <section id="content">
            ...
            <section id='contentwrapp'>
				<section class="error">
                        <h1 class="errorh1">Sidan "tytos.se<?php echo $_SERVER['REQUEST_URI'] ?>" finns ej<br>(ERROR 404)</h1>
                    <h4 class="errorh4" style="width: 400px">Tyvärr fungerade inte den länk du försökte gå till. 
