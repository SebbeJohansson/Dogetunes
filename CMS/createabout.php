...
<html lang="sv">
<head>
    <title>CMS - Create about texts</title>
    <meta charset="utf-8">
...
<body>
	...
	<section id="content">
		...
		<section id="contentholder">
			...
			<section id='hwrapp'><h3>Create about text</h3></section>
			<form method="post" action="includes/doCreateAbout.php">
                <label>Titel</label>
				<input name="name" type="text" placeholder="Titel" required><br>
				<label>Text</label><br>
				<div>
					<div>
						<textarea id="elm1" name="text" rows="30" cols="80" style="width: 80%" required></textarea>
					</div>
				</div>
				<input type="submit" name="submit" value="Create About Text" class="submit">
			</form>
